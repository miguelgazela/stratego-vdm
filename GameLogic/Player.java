...
// This file was genereted from "/Users/migueloliveira/Dropbox/projects/stratego/Player.vdmpp".
...
// ***** VDMTOOLS START Name=PlayerSentinel KEEP=NO
  class PlayerSentinel extends Sentinel {
    ...
    public final int removeAllPieces = 14;
...
// ***** VDMTOOLS START Name=removeAllPieces KEEP=NO
  public void removeAllPieces () throws CGException {
    sentinel.entering(((PlayerSentinel)sentinel).removeAllPieces);
    try {
      if (!this.pre_removeAllPieces().booleanValue()) 
        UTIL.RunTime("Precondition failure in removeAllPieces");
      List rhs_2 = new ArrayList();
      if (!(((Object)rhs_2) instanceof List)) 
        UTIL.RunTime("Incompatible type");
      pieces = UTIL.ConvertToList(UTIL.clone(rhs_2));
      if (!this.inv_Player().booleanValue()) 
        UTIL.RunTime("Instance invariant failure in Player");
      List rhs_4 = new ArrayList();
      if (!(((Object)rhs_4) instanceof List)) 
        UTIL.RunTime("Incompatible type");
      deadPieces = UTIL.ConvertToList(UTIL.clone(rhs_4));
      if (!this.inv_Player().booleanValue()) 
        UTIL.RunTime("Instance invariant failure in Player");
    }
    finally {
      sentinel.leaving(((PlayerSentinel)sentinel).removeAllPieces);
    }
  }
// ***** VDMTOOLS END Name=removeAllPieces


// ***** VDMTOOLS START Name=pre_removeAllPieces KEEP=NO
  public Boolean pre_removeAllPieces () throws CGException {
    return Boolean.valueOf(!UTIL.equals(pieces, new ArrayList()));
  }
// ***** VDMTOOLS END Name=pre_removeAllPieces
