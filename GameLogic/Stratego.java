...
// This file was genereted from "/Users/migueloliveira/Dropbox/projects/stratego/Stratego/Stratego.vdmpp".
...
// ***** VDMTOOLS START Name=makeMove#2|Coord|Coord KEEP=NO
  public Number makeMove (final Coord srcPos, final Coord destPos) throws CGException {
    ...
    try {
      if (!this.pre_makeMove(srcPos, destPos).booleanValue()) 
        UTIL.RunTime("Precondition failure in makeMove");
      {
        Piece srcPiece = null;
...
// ***** VDMTOOLS START Name=pre_makeMove#2|Coord|Coord KEEP=NO
  public Boolean pre_makeMove (final Coord srcPos, final Coord destPos) throws CGException {
    Boolean varRes_3 = null;
    Boolean var1_4 = null;
    Boolean var1_5 = null;
    Set var2_8 = new HashSet();
    var2_8 = new HashSet();
    int ubi_13 = Board.BOARDSIZE.intValue();
    for (int count_11 = 1; count_11 <= ubi_13; count_11++) 
      var2_8.add(new Integer(count_11));
    if ((var1_5 = Boolean.valueOf(UTIL.Contains(var2_8, srcPos.getX()))).booleanValue()) {
      Set var2_16 = new HashSet();
      var2_16 = new HashSet();
      int ubi_21 = Board.BOARDSIZE.intValue();
      for (int count_19 = 1; count_19 <= ubi_21; count_19++) 
        var2_16.add(new Integer(count_19));
      var1_5 = Boolean.valueOf(UTIL.Contains(var2_16, srcPos.getY()));
    }
    if ((var1_4 = var1_5).booleanValue()) {
      Set var2_24 = new HashSet();
      var2_24 = new HashSet();
      int ubi_29 = Board.BOARDSIZE.intValue();
      for (int count_27 = 1; count_27 <= ubi_29; count_27++) 
        var2_24.add(new Integer(count_27));
      var1_4 = Boolean.valueOf(UTIL.Contains(var2_24, destPos.getX()));
    }
    if ((varRes_3 = var1_4).booleanValue()) {
      Set var2_32 = new HashSet();
      var2_32 = new HashSet();
      int ubi_37 = Board.BOARDSIZE.intValue();
      for (int count_35 = 1; count_35 <= ubi_37; count_35++) 
        var2_32.add(new Integer(count_35));
      varRes_3 = Boolean.valueOf(UTIL.Contains(var2_32, destPos.getY()));
    }
    return varRes_3;
  }
// ***** VDMTOOLS END Name=pre_makeMove#2|Coord|Coord
  ...
  private void makeBattle (final Coord srcPos, final Coord destPos, final Piece srcPiece, final Piece destPiece) throws CGException {
    ...
    try {
      ...
      if (cond_5.booleanValue()) {
        Piece obj_68 = board.getPieceAtPosition(srcPos);
        obj_68.wasSpoted();
...
// ***** VDMTOOLS START Name=pre_makeBattle#4|Coord|Coord|Piece|Piece KEEP=NO
  private Boolean pre_makeBattle (final Coord srcPos, final Coord destPos, final Piece srcPiece, final Piece destPiece) throws CGException {
    ...
    Boolean var1_7 = null;
    Boolean var1_8 = null;
    Set var2_11 = new HashSet();
    var2_11 = new HashSet();
    int ubi_16 = Board.BOARDSIZE.intValue();
    for (int count_14 = 1; count_14 <= ubi_16; count_14++) 
      var2_11.add(new Integer(count_14));
    if ((var1_8 = Boolean.valueOf(UTIL.Contains(var2_11, srcPos.getX()))).booleanValue()) {
      Set var2_19 = new HashSet();
      var2_19 = new HashSet();
      int ubi_24 = Board.BOARDSIZE.intValue();
      for (int count_22 = 1; count_22 <= ubi_24; count_22++) 
        var2_19.add(new Integer(count_22));
      var1_8 = Boolean.valueOf(UTIL.Contains(var2_19, srcPos.getY()));
    }
    if ((var1_7 = var1_8).booleanValue()) {
      Set var2_27 = new HashSet();
      var2_27 = new HashSet();
      int ubi_32 = Board.BOARDSIZE.intValue();
      for (int count_30 = 1; count_30 <= ubi_32; count_30++) 
        var2_27.add(new Integer(count_30));
      var1_7 = Boolean.valueOf(UTIL.Contains(var2_27, destPos.getX()));
    }
    if ((var1_6 = var1_7).booleanValue()) {
      Set var2_35 = new HashSet();
      var2_35 = new HashSet();
      int ubi_40 = Board.BOARDSIZE.intValue();
      for (int count_38 = 1; count_38 <= ubi_40; count_38++) 
        var2_35.add(new Integer(count_38));
      var1_6 = Boolean.valueOf(UTIL.Contains(var2_35, destPos.getY()));
    }
    if ((varRes_5 = var1_6).booleanValue()) 
      varRes_5 = Boolean.valueOf(!UTIL.equals(srcPiece.getColor(), destPiece.getColor()));
    return varRes_5;
  }
...
// ***** VDMTOOLS START Name=makeBattleAux#3|Coord|Coord|Piece KEEP=NO
  private void makeBattleAux (final Coord srcPos, final Coord destPos, final Piece destPiece) throws CGException {
    ...
    try {
      if (!this.pre_makeBattleAux(srcPos, destPos, destPiece).booleanValue()) 
...
// ***** VDMTOOLS START Name=pre_makeBattleAux#3|Coord|Coord|Piece KEEP=NO
  private Boolean pre_makeBattleAux (final Coord srcPos, final Coord destPos, final Piece destPiece) throws CGException {
    ...
    var2_10 = new HashSet();
    int ubi_15 = Board.BOARDSIZE.intValue();
    for (int count_13 = 1; count_13 <= ubi_15; count_13++) 
      var2_10.add(new Integer(count_13));
    if ((var1_7 = Boolean.valueOf(UTIL.Contains(var2_10, srcPos.getX()))).booleanValue()) {
      Set var2_18 = new HashSet();
      var2_18 = new HashSet();
      int ubi_23 = Board.BOARDSIZE.intValue();
      for (int count_21 = 1; count_21 <= ubi_23; count_21++) 
        var2_18.add(new Integer(count_21));
      var1_7 = Boolean.valueOf(UTIL.Contains(var2_18, srcPos.getY()));
    }
    if ((var1_6 = var1_7).booleanValue()) {
      Set var2_26 = new HashSet();
      var2_26 = new HashSet();
      int ubi_31 = Board.BOARDSIZE.intValue();
      for (int count_29 = 1; count_29 <= ubi_31; count_29++) 
        var2_26.add(new Integer(count_29));
      var1_6 = Boolean.valueOf(UTIL.Contains(var2_26, destPos.getX()));
    }
    if ((var1_5 = var1_6).booleanValue()) {
      Set var2_34 = new HashSet();
      var2_34 = new HashSet();
      int ubi_39 = Board.BOARDSIZE.intValue();
      for (int count_37 = 1; count_37 <= ubi_39; count_37++) 
        var2_34.add(new Integer(count_37));
      var1_5 = Boolean.valueOf(UTIL.Contains(var2_34, destPos.getY()));
    }
    if ((varRes_4 = var1_5).booleanValue()) {
      Piece obj_44 = board.getPieceAtPosition(srcPos);
      varRes_4 = Boolean.valueOf(!UTIL.equals(obj_44.getColor(), destPiece.getColor()));
    }
    return varRes_4;
  }
// ***** VDMTOOLS END Name=pre_makeBattleAux#3|Coord|Coord|Piece
...
// ***** VDMTOOLS START Name=pre_moveIsValid#3|Coord|Coord|Piece KEEP=NO
  public Boolean pre_moveIsValid (final Coord srcPos, final Coord destPos, final Piece srcPiece) throws CGException {
    ...
    var2_9 = new HashSet();
    int ubi_14 = Board.BOARDSIZE.intValue();
    for (int count_12 = 1; count_12 <= ubi_14; count_12++) 
      var2_9.add(new Integer(count_12));
    if ((var1_6 = Boolean.valueOf(UTIL.Contains(var2_9, srcPos.getX()))).booleanValue()) {
      Set var2_17 = new HashSet();
      var2_17 = new HashSet();
      int ubi_22 = Board.BOARDSIZE.intValue();
      for (int count_20 = 1; count_20 <= ubi_22; count_20++) 
        var2_17.add(new Integer(count_20));
      var1_6 = Boolean.valueOf(UTIL.Contains(var2_17, srcPos.getY()));
    }
    if ((var1_5 = var1_6).booleanValue()) {
      Set var2_25 = new HashSet();
      var2_25 = new HashSet();
      int ubi_30 = Board.BOARDSIZE.intValue();
      for (int count_28 = 1; count_28 <= ubi_30; count_28++) 
        var2_25.add(new Integer(count_28));
      var1_5 = Boolean.valueOf(UTIL.Contains(var2_25, destPos.getX()));
    }
    if ((varRes_4 = var1_5).booleanValue()) {
      Set var2_33 = new HashSet();
      var2_33 = new HashSet();
      int ubi_38 = Board.BOARDSIZE.intValue();
      for (int count_36 = 1; count_36 <= ubi_38; count_36++) 
        var2_33.add(new Integer(count_36));
      varRes_4 = Boolean.valueOf(UTIL.Contains(var2_33, destPos.getY()));
    }
    return varRes_4;
  }
