...
// This file was genereted from "/Users/migueloliveira/Dropbox/projects/stratego/Board/Board.vdmpp".
...
// ***** VDMTOOLS START Name=pre_placePieces#2|List|Object KEEP=NO
  private Boolean pre_placePieces (final List pieces, final Object playerColor) throws CGException {
    ...
    if ((varRes_3 = var1_4).booleanValue()) {
      boolean tmpQuant_16 = false;
      {
        Set e1_set_19 = new HashSet(pieces);
        Piece piece1 = null;
        Piece piece2 = null;
        Set e_set_35 = e1_set_19;
        Set tmpSet_38 = new HashSet(e_set_35);
        for (Iterator enm_37 = tmpSet_38.iterator(); enm_37.hasNext() && !tmpQuant_16; ) {
          Piece elem_36 = (Piece)enm_37.next();
          /* piece2 */
          piece2 = elem_36;
          Set tmpSet_34 = new HashSet(e1_set_19);
          for (Iterator enm_33 = tmpSet_34.iterator(); enm_33.hasNext() && !tmpQuant_16; ) {
            Piece elem_32 = (Piece)enm_33.next();
            /* piece1 */
            piece1 = elem_32;
            Boolean pred_20 = null;
            Boolean var1_21 = null;
            if ((var1_21 = Boolean.valueOf(!UTIL.equals(piece1, piece2))).booleanValue()) 
              var1_21 = Boolean.valueOf(!UTIL.equals(piece1.getColor(), piece2.getColor()));
            if ((pred_20 = var1_21).booleanValue()) 
              pred_20 = Boolean.valueOf(!UTIL.equals(piece1.getColor(), playerColor));
            if (pred_20.booleanValue()) 
              tmpQuant_16 = true;
          }
        }
      }
      varRes_3 = Boolean.valueOf(!tmpQuant_16);
    }
    return varRes_3;
  }
...
// ***** VDMTOOLS START Name=pre_addPiece#2|Piece|Coord KEEP=NO
  public Boolean pre_addPiece (final Piece piece, final Coord pos) throws CGException {
    ...
    var2_9 = new HashSet();
    int ubi_14 = BOARDSIZE.intValue();
    for (int count_12 = 1; count_12 <= ubi_14; count_12++) 
      var2_9.add(new Integer(count_12));
    if ((var1_6 = Boolean.valueOf(UTIL.Contains(var2_9, pos.getX()))).booleanValue()) {
      Set var2_17 = new HashSet();
      var2_17 = new HashSet();
      int ubi_22 = BOARDSIZE.intValue();
      for (int count_20 = 1; count_20 <= ubi_22; count_20++) 
        var2_17.add(new Integer(count_20));
      var1_6 = Boolean.valueOf(UTIL.Contains(var2_17, pos.getY()));
    }
    if ((var1_5 = var1_6).booleanValue()) 
      var1_5 = isPositionFree(pos);
    if ((var1_4 = var1_5).booleanValue()) 
      var1_4 = Boolean.valueOf(UTIL.equals(piece.getColor(), new quotes.Red()));
    if (!(varRes_3 = var1_4).booleanValue()) 
      varRes_3 = Boolean.valueOf(UTIL.equals(piece.getColor(), new quotes.Blue()));
    return varRes_3;
  }
