...
// ***** VDMTOOLS START Name=BoardSentinel KEEP=NO
  class BoardSentinel extends Sentinel {
    ...
    public final int placePiecesP1 = 9;

    public final int placePiecesP2 = 10;

    public final int isPositionFree = 11;

    public final int isPositionLake = 12;

    public final int getPieceAtPosition = 13;

    public final int getNumberPiecesOnBoard = 14;
...
// ***** VDMTOOLS START Name=pre_placePiece#3|Coord|Piece|Player KEEP=NO
  public Boolean pre_placePiece (final Coord destPos, final Piece piece, final Player player) throws CGException {
    ...
    if (!(varRes_4 = Boolean.valueOf(UTIL.equals(player.getName(), new String("P1")))).booleanValue()) {
      Boolean var2_8 = null;
      Boolean var1_9 = null;
      if ((var1_9 = Boolean.valueOf(UTIL.equals(player.getName(), new String("P2")))).booleanValue()) {
        Set var2_15 = new HashSet();
        var2_15 = new HashSet();
        int ubi_20 = BOARDSIZE.intValue();
        for (int count_18 = 1; count_18 <= ubi_20; count_18++) 
          var2_15.add(new Integer(count_18));
        var1_9 = Boolean.valueOf(UTIL.Contains(var2_15, destPos.getX()));
      }
      if ((var2_8 = var1_9).booleanValue()) {
        Set var2_23 = new HashSet();
        var2_23 = new HashSet();
        int ubi_28 = BOARDSIZE.intValue();
        for (int count_26 = 1; count_26 <= ubi_28; count_26++) 
          var2_23.add(new Integer(count_26));
        var2_8 = Boolean.valueOf(UTIL.Contains(var2_23, destPos.getY()));
      }
      varRes_4 = var2_8;
    }
    return varRes_4;
